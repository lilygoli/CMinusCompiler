...
class Parser():
    ...
    def Vardeclarationprime(self):
        ...
        if LA in [';']:
            self.code_generator.code_gen("popName", self.identifier_name)
            self.match(';')
        elif LA in ['[']:
            self.match('[')
    ...
    def Fundeclarationprime(self):
        ...
        if LA in first["Fundeclarationprime"]:
            # jadid
            self.code_generator.code_gen("allocateFunc", self.identifier_name)
            self.match('(')
    ...
    def Params(self):
        ...
        if LA in ['int']:
            self.match('int')
            self.code_generator.code_gen("assignAddr", self.identifier_name)
            self.code_generator.code_gen("setParam", self.identifier_name)
            self.match(self.cur_token)
    ...
    def Statement(self):
        ...
        if LA in ['{']:
            ...
            self.go_next_level(self.Output, "Output")
    ...
    def Expressionstmt(self):
        ...
        if LA in ['break']:
            self.match('break')
            self.match(';')
            self.code_generator.code_gen("breakJump", self.identifier_name)
        elif LA in [';']:
            self.match(';')
    ...
    def Returnstmtprime(self):
        ...
        if LA in [';']:
            ...
            self.go_next_level(self.Expression, "Expression")
            self.code_generator.code_gen("pushRes", self.identifier_name)
            self.match(';')
    ...
    def Vars(self):
        ...
        if LA in first['Vars']:
            ...
            self.code_generator.code_gen("assignFor", self.identifier_name)
    ...
    def Varzegond(self):
        ...
        if LA in first['Varzegond']:
            self.match(',')
            self.code_generator.code_gen("jumpFor", self.identifier_name)
            self.go_next_level(self.Var, "Var")
            self.code_generator.code_gen("assignFor", self.identifier_name)
            self.go_next_level(self.Varzegond, "Var-zegond")
